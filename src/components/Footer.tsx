...
function Footer() {
    return (
        ...
        <footer className="w-full min-h-[250px] bg-[#7525a7] flex flex-col items-center ">
            <div id="footer" className="w-full flex flex-col justify-between items-center p-[17px] 
            sm:flex-row sm:items-start lg:justify-center">
                <ul className="w-[170px] p-[10px] list-none">
                    <li className="pb-[20px] font-bold text-center sm:text-start">
                        <a className="text-white no-underline" href="./index.html">Ofertas</a>
                    </li>
                    <li className="pt-[5px] pb-[5px] text-center sm:text-start">
            ...
            <div className="w-full border-t border-t-[#ba53fb] text-center text-white font-bold pt-[30px] pb-[30px] box-border
            lg:w-[1024px]">Curso de HTML + CSS 2023</div>
            </footer>
        </>
    )
}
