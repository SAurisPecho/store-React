        ...
        <footer className="min-h-[250px] bg-[#7525a7] flex flex-col items-center">
            <div id="footer" className="w-[1080px] flex justify-between p-[10px]">
                <ul className="w-[170px] p-[10px] list-none">
                    <li className="pb-[20px] font-bold">
            ...
            <div className="w-[1080px] border-t border-t-[#ba53fb] text-center text-white font-bold pt-[30px] pb-[30px] box-border">Curso de HTML + CSS 2023</div>
            </footer>
        </>
    )
}
